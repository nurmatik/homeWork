...
export const HW2 = () => {
  ...
  const filterUsers = (city: string) => {
    const filteredUsers = currentUsers.myFriends.filter(user => user.address.city === city)  //'НУЖНО ПРОФИЛЬТРОВАТЬ ДРУЗЕЙ. ОСТАВЛЯЕМ ТОЛЬКО ТЕХ, КОТОРЫЕ ЖИВУТ В ГОРОДЕ LOS ANGELES';
